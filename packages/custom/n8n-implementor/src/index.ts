/**
 * Generated by /model-creator for the "n8n-implementor" n8n automation.
 * Could not get a structured answer from the response-shape check (error); assuming the standard shape.
 * @module @deepseek-ai/dsh-n8n-implementor
 */
...
declare module '@deepseek-ai/cordis' {
  interface Context {
    n8nImplementorBridge: BridgeController
  }
}
...
const DEFAULT_PATH = '/n8n-implementor/v1/chat/completions'
...
export class BridgeController extends Service {
  ...
  constructor(ctx: Context, rawConfig: BridgeConfig) {
    super(ctx, 'n8nImplementorBridge')
