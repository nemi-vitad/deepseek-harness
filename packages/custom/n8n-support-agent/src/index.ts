/**
 * Generated by /model-creator for the "n8n-support-agent" n8n automation.
 * Could not get a structured answer from the response-shape check (error); assuming the standard shape.
 * @module @deepseek-ai/dsh-n8n-support-agent
 */
...
declare module '@deepseek-ai/cordis' {
  interface Context {
    n8nSupportAgentBridge: BridgeController
  }
}
...
const DEFAULT_PATH = '/n8n-support-agent/v1/chat/completions'
...
export class BridgeController extends Service {
  ...
  constructor(ctx: Context, rawConfig: BridgeConfig) {
    super(ctx, 'n8nSupportAgentBridge')
