/**
 * Generated by /model-creator for the "who-is-the-user" n8n automation.
 * Could not get a structured answer from the response-shape check (error); assuming the standard shape.
 * @module @deepseek-ai/dsh-who-is-the-user
 */
...
declare module '@deepseek-ai/cordis' {
  interface Context {
    whoIsTheUserBridge: BridgeController
  }
}
...
const DEFAULT_PATH = '/who-is-the-user/v1/chat/completions'
