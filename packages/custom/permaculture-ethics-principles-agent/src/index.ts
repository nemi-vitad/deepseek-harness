/**
 * Generated by /model-creator for the "permaculture-ethics-principles-agent" n8n automation.
 * Could not get a structured answer from the response-shape check (error); assuming the standard shape.
 * @module @deepseek-ai/dsh-permaculture-ethics-principles-agent
 */
...
declare module '@deepseek-ai/cordis' {
  interface Context {
    permacultureEthicsPrinciplesAgentBridge: BridgeController
  }
}
...
const DEFAULT_PATH = '/permaculture-ethics-principles-agent/v1/chat/completions'
...
export class BridgeController extends Service {
  ...
  constructor(ctx: Context, rawConfig: BridgeConfig) {
    super(ctx, 'permacultureEthicsPrinciplesAgentBridge')
