...
declare module '@deepseek-ai/cordis' {
  interface Context {
    n8nDesignBridge: BridgeController
  }
}
...
const DEFAULT_PATH = '/n8n-design/v1/chat/completions'
