/**
 * Generated by /model-creator for the "information-support-agent" n8n automation.
 * Could not get a structured answer from the response-shape check (error); assuming the standard shape.
 * @module @deepseek-ai/dsh-information-support-agent
 */
...
declare module '@deepseek-ai/cordis' {
  interface Context {
    informationSupportAgentBridge: BridgeController
  }
}
...
const DEFAULT_PATH = '/information-support-agent/v1/chat/completions'
...
export class BridgeController extends Service {
  ...
  constructor(ctx: Context, rawConfig: BridgeConfig) {
    super(ctx, 'informationSupportAgentBridge')
